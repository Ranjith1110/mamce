...
<section id="banner">
    <div class="dep-banner">
        <div class="py-lg-10 py-md-8 py-6 position-relative">
            <img class="w-100 object-fit-cover" src="{{asset('images/separateCourses/ai&mlImg/ai&ml-banner.svg')}}"
                alt="">
            <div class="position-absolute">
                <h2 class="text-white text-center fw-bolder">Artificial Intelligence & Machine Learning</h2>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center courses-btn">
            ...
            <a href="#" style="background-color: #9d7651; border: 2px solid #dfcfc1;"
                ...
                data-bs-target="#popupForm">Book Your Admission in AI&ML</a>
        </div>
