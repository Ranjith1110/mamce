        ...
        <div class="dep-banner">
            <div class="py-lg-10 py-md-8 py-6 position-relative">
                ...
                <div class="position-absolute">
                    <h2 class="text-white text-center fw-bolder">New Adminssion Fees</h2>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row g-0 contact-card">
                ...
                <div class="col-md-6 p-10">
                    <form id="new-admission-fees-form" method="POST" action="{{route('payment-submit')}}">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <input style="border: 2px solid #dfcfc1;" type="text" name="pay_for" class="form-control py-3"
                                placeholder="pay for" required readonly value="New Admission Fees">
                        </div>
                        <div class="mb-4">
